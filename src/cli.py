...
class DataCompareCLI:
    ...
    def _parse_args(self):
        ...
        parser.add_argument(
            "--key",
            help="Unique key column for element-wise comparison (required for element)"
        )
        parser.add_argument(
            "--custom-condition",
        ...
        # New argument for specifying a subset of columns to compare
        parser.add_argument(
            "--columns",
            help="Comma-separated list of columns to compare. If omitted, compares all columns."
        )
